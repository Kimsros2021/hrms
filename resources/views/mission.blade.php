					...
					<div class="card-body">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#home">Late and Missed Scan</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#menu1">Mission</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#menu2">Work on Side</a>
								</li>
							</ul>
							...
							<div class="tab-content">
								<div id="home" class="container tab-pane active"><br>
									<div class="co-md-12 text-right">
										<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Add</a>
									</div>
