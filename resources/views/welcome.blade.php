...
{{-- <script src="../../../../../../../asset/codefund.io/properties/441/funder.js" async="async"></script> --}}
...
<body>
    {{-- <link rel="stylesheet" href="../../../../../../asset/images/demobar_w3_4thDec2019.css"> --}}
	<!-- Demo bar start -->
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="asset/images/1.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="asset/images/2.png"></span>
                                <span class="subject">
